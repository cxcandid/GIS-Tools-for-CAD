...
Polygon and MultiPolygon features are written as HATCH entities by default. To write these features as LWPOLYLINE/POLYLINE entities instead, we must set a Windows system variable `DXF_WRITE_HATCH=FALSE`.
